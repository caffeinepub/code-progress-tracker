...
import type { CodeChefStats as _CodeChefStats, FriendshipStatus as _FriendshipStatus, LeetCodeStats as _LeetCodeStats, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async acceptFriendRequest(arg0: Principal): Promise<FriendshipStatus> {
        if (this.processError) {
            try {
                const result = await this.actor.acceptFriendRequest(arg0);
                return from_candid_FriendshipStatus_n1(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getFriendStatus(arg0: Principal, arg1: Principal): Promise<FriendshipStatus | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getFriendStatus(arg0, arg1);
    ...
    async getFriends(arg0: Principal): Promise<Array<UserProfile>> {
        if (this.processError) {
            try {
    ...
    async refreshCodechefStats(): Promise<CodeChefStats | null> {
        if (this.processError) {
            try {
                const result = await this.actor.refreshCodechefStats();
    ...
    async refreshLeetcodeStats(): Promise<LeetCodeStats | null> {
        if (this.processError) {
            try {
                const result = await this.actor.refreshLeetcodeStats();
    ...
    async registerOrUpdateProfile(arg0: UserProfileInput): Promise<UserProfile> {
        if (this.processError) {
            try {
    ...
    async rejectFriendRequest(arg0: Principal): Promise<FriendshipStatus> {
        if (this.processError) {
            try {
    ...
    async sendFriendRequest(arg0: Principal): Promise<FriendshipStatus> {
        if (this.processError) {
            try {
...
function from_candid_FriendshipStatus_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FriendshipStatus): FriendshipStatus {
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_LeetCodeStats]): LeetCodeStats | null {
...
function from_candid_opt_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FriendshipStatus]): FriendshipStatus | null {
    return value.length === 0 ? null : from_candid_FriendshipStatus_n1(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_CodeChefStats]): CodeChefStats | null {
    return value.length === 0 ? null : value[0];
}
